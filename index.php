  ...
  <div class="row">
    <div class="col-md-6">
        ...
        <div class="banner-text">
          ...
          <p class="bt2"><span class="bt3">BAUHINIA</span>Store</p>
          <p class="bt4">Fashion that fits your lifestyle,Clothing that makes you feel confident and beautiful.<br>Find your perfect fit at our store. </p>
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <div class="col-md-3 col-sm-6 col-6">
              ...
              <div>
                ...
                <span> <h7>LKR </h7><?php echo $row["Price"] ?></span> 
...
<div class="welcome">
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-lg-6 col-sm-12">
       ...
       <div class="row" id="wel1">
          ...
          <div class="col-md-10  col-lg-10 col-10">
           ...
           <p class="wp">There are many variations of passages available<br>
      ...
      <div class="col-md-12 col-lg-6 col-sm-12">
        <img src="img/girls.jpg" class="img-fluid">
      </div>
    </div>
  </div>
</div>
